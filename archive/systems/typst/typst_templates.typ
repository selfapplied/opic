...
#let bloom-icon(size: 24pt, type: "default") = {
  let svg-path = if type == "wave" {
    "examples/images/bloom_wave.svg"
  } else if type == "energy" {
    "examples/images/bloom_energy.svg"
  } else if type == "coherence" {
    "examples/images/bloom_coherence.svg"
  } else if type == "zeta" {
    "examples/images/bloom_zeta.svg"
  } else if type == "flux" {
    "examples/images/bloom_flux.svg"
  } else if type == "xi" {
    "examples/images/bloom_xi.svg"
  } else {
    "examples/images/bloom_icon.svg"
  }
